...
model.compile(loss=keras.losses.categorical_crossentropy,optimizer=tensorflow.keras.optimizers.Adadelta(learning_rate=0.01),metrics=['acc'])
...
(y_train, x_train) = createTrainTestData(pos_Train,neg_Train,";dict")
